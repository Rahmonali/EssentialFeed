//
//  RemoteFeedFromRemoteTests.swift
//  EssentialFeedTests
//
...
class RemoteFeedFromRemoteTests: XCTestCase {
    ...
    func test_load_deliversItemsOn200HTTPResponseWithJSONItems() {
        ...
        let item2 = makeItem(id: UUID(), description: "a description", location: "a loacation", imageURL: URL(string: "http://another-url.com")!)
