...
class FeedPresenterTests: XCTestCase {
    ...
    func test_didFinishLoadingFeed_displaysFeedAndStopsLaoding() {
        let (sut, view) = makeSUT()
    ...
    func test_didFinishLoadingFeedWithError_displaysLocalizationErrorMessageAndStopsLoading() {
        let (sut, view) = makeSUT()
